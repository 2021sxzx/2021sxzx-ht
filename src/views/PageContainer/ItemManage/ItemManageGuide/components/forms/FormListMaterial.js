                        ...
                        <div className={style.singleLine}>
                            ...
                            <div className={style.otherDatas}>
                                <div className={style.oneRow}>
                                    ...
                                    <Input className={style.shortTextArea}
                                           onChange={function (e) {
                                               handleChange(e.target.value, 'origin', index)
                                           }}
                                           value={item.origin}
                                           autoSize={true}
                                           placeholder='请输入非负数作为原件数量'
                                           maxLength={props.maxLength}
                                           type={'number'}
                                           min={0}
                                           max={100}
                                ...
                                <div className={style.oneRow}>
                                    ...
                                    <Select className={style.select} value={item.material_form}
                                    ...
                                    <TextArea disabled={!(pageFormatEnabled[index])}
                                              className={style.pageFormat}
                                              onChange={function (e) {
                                                  handleChange(e.target.value, 'page_format', index)
                                              }}
                                              value={item.page_format}
                                              autoSize={true}
                                ...
                                <div className={style.oneRow}>
                                    ...
                                    <Select className={style.select} value={item.material_necessity}
                                            onChange={function (value) {
                                    ...
                                    <Select className={style.select} value={item.material_type}
                                            onChange={function (value) {
                                    ...
                                    <Select className={style.smallSelect} value={item.submissionrequired}
                                            onChange={function (value) {
